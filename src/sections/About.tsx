...
const About = ({ onMerchClick }: AboutProps) => {
  ...
  return (
    <section id="about" className="min-h-screen py-20 bg-space-900 relative">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <p className="text-lg text-gray-300 leading-relaxed">
              Quantum Aberration est un groupe de death metal technique parisien
              formé en 2022. Nous explorons les confins de l'univers à travers
              une musique complexe et brutale, mêlant technicité extrême et
              atmosphères cosmiques.
            </p>
      ...
      {showGame && <GamePopup onClose={() => setShowGame(false)} onGameEnd={handleGameEnd} />}
    </section>
  );
};
