...
const Merch = ({ selectedProductSlug, onProductClose, onProductOpen }: MerchProps) => {
    ...
    <section id="merch" className="min-h-screen py-20 bg-space-900 relative">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {merch.map((item) => (
            <div key={item.id} className="bg-space-700 rounded-lg overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300 border border-space-600">
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-2xl font-bold text-cosmic-purple">{item.price}€</span>
                </div>
