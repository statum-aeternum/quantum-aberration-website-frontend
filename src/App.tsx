...
function App() {
  ...
  const [selectedMerchSlug, setSelectedMerchSlug] = useState<string | null>(null);
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        ...
        <News selectedNewsSlug={selectedNewsSlug} onNewsClose={closeNewsItem} onNewsOpen={openNewsItem} />
        <Merch selectedProductSlug={selectedMerchSlug} onProductClose={closeMerchProduct} onProductOpen={openMerchProduct} />
        <Contact />
      </main>
